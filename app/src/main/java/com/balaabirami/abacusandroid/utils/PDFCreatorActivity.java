            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        PDFUtil.getInstance().generatePDF(pdfPageViewList, UIUtils.createTempFileWithName(getApplicationContext(), filename + ".pdf", false).getAbsolutePath(), pdfUtilListener);
                    }
                });
            }
        });
